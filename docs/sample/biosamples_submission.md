...
1. After successful [validation](biosamples_validation_conversion.md) you should be allowed to do a submission to [BioSamples](https://www.ebi.ac.uk/biosamples/) using our 
[on-line tool](https://data.faang.org/validation/samples).
   ![Screenshot](../img/new_system/sample/prepare_data_for_submission.png)
...
save this file in a safe place for further reference.
   ![Screenshot](../img/new_system/sample/submission_results.png)
