...
Upload all track files to your Webin FTP area.
...
1. **Name:** Name of your trackhub directory. This field is mandatory.
...
Fill out one row for each track file that you have uploaded to Webin. This information will be used to generate the trackDb.txt file for the hub, to organise your track files into subdirectories, and to associate the track files to the related FAANG specimen records.
...
2. **File Path:** Name of the track file in Webin. This field is mandatory.
...
------------ | ------------- | ------------ | ------------ | ------------ | ------------ | ------------
Track1 | test1.Bigbed | bigBed | t1 | test track 1 | SAMEA104728909 | sub_dir1
Track2_1 | test2_1.Bigbed | bigBed | t2.1 | test track 2.1 | SAMEA104728910 | sub_dir2
Track2_2 | test2_2.Bigbed | bigBed | t2.2 | test track 2.2 | SAMEA104728910 | sub_dir2

## Submitting Track Hub

### Login to Webin

Login using your Webin credentials.
